...
class CvCreator extends Component {
  ...
  render() {
    ...
    if (this.state.isGerman === true) {
      ...
      translateExp = this.state.experience.map(
        (form) =>
          (translateExp = (
            <ExperienceForm
              key={form.id}
    ...
    if (this.state.isGerman === true) {
      ...
      translateSchool = this.state.school.map(
        (form) =>
          (translateSchool = (
            <SchoolFrom
              key={form.id}
    ...
    if (this.state.isGerman === true) {
      ...
      translateLanguage = this.state.languages.map(
        (form) =>
          (translateLanguage = (
            <LanguageFrom
              key={form.id}
    ...
    if (this.state.isGerman === true) {
      ...
      translateComputer = this.state.computerSkill.map(
        (form) =>
          (translateComputer = (
            <ComputerForm
              key={form.id}
    ...
    let newComputerInfo = this.state.computerSkill.map((lan) => (
      <ComputerInfo key={lan.id} id={lan.id} computer={lan.computerSkills} />
    ));
      ...
      <div>
        {/* <div className="Title">
          ...
          <div className="lanButtons">
            <button className="btn " onClick={this.changeLanguageGerm}>
              German
            </button>
            <button className="btn " onClick={this.changeLanguageEng}>
              English
            </button>
          </div>
        </div> */}
        ...
        <div className="Cv-container">
          <div className="Cv-forms">
            ...
            <div className="Define">
              ...
              <button className="btn btn-info" onClick={this.addExperience}>
                Add
              </button>
            </div>
            ...
            <div className="Define">
              ...
              <button className="btn btn-info" onClick={this.addSchool}>
                Add
              </button>
            </div>
            <div className="Define">
              ...
              <button className="btn btn-info" onClick={this.addComputerSkill}>
                Add
              </button>
            </div>
            <div className="Define">
              ...
              <button className="btn btn-info" onClick={this.addLanguage}>
                Add
              </button>
            </div>
            ...
            <div className="ExtraSkills">
              ...
              <div className="skillGrid">
                <div className="LanInfo">
                  ...
                  <div>{newLanguageInfo}</div>
                </div>
                <div className="SkillInfo">
                  <span id="computerSpan">{this.state.computerTitle}:</span>
                  <div className="computer-info">{newComputerInfo}</div>
                </div>
              </div>
            </div>
        ...
        <div className="footer">
          <footer>
            ...
            <a href="https://github.com/NadimRadjab"></a>
          </footer>
        </div>
      </div>
    );
